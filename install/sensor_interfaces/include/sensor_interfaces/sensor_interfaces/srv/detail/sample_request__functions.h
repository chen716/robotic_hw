...
#ifndef SENSOR_INTERFACES__SRV__DETAIL__SAMPLE_REQUEST__FUNCTIONS_H_
#define SENSOR_INTERFACES__SRV__DETAIL__SAMPLE_REQUEST__FUNCTIONS_H_
 ...
 * calls
 * sensor_interfaces__srv__SampleRequest_Request__init().
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Request__fini()
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sensor_interfaces__srv__SampleRequest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_interfaces
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_interfaces
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sensor_interfaces__srv__SampleRequest_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_interfaces
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sensor_interfaces__srv__SampleRequest_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_interfaces
...
/**
 * It calls
 * sensor_interfaces__srv__SampleRequest_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SENSOR_INTERFACES__SRV__DETAIL__SAMPLE_REQUEST__FUNCTIONS_H_
