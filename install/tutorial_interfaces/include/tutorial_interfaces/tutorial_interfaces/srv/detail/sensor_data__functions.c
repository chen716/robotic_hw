...
tutorial_interfaces__srv__SensorData_Request__create()
{
  ...
  tutorial_interfaces__srv__SensorData_Request * msg = (tutorial_interfaces__srv__SensorData_Request *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__srv__SensorData_Request));
  bool success = tutorial_interfaces__srv__SensorData_Request__init(msg);
  if (!success) {
...
tutorial_interfaces__srv__SensorData_Request__destroy(tutorial_interfaces__srv__SensorData_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tutorial_interfaces__srv__SensorData_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tutorial_interfaces__srv__SensorData_Request__Sequence__init(tutorial_interfaces__srv__SensorData_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Request * data = NULL;

  if (size) {
    data = (tutorial_interfaces__srv__SensorData_Request *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__srv__SensorData_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__srv__SensorData_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutorial_interfaces__srv__SensorData_Request__fini(&data[i - 1]);
      }
...
tutorial_interfaces__srv__SensorData_Request__Sequence__fini(tutorial_interfaces__srv__SensorData_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__srv__SensorData_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Request__Sequence * array = (tutorial_interfaces__srv__SensorData_Request__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__srv__SensorData_Request__Sequence__init(array, size);
  if (!success) {
...
tutorial_interfaces__srv__SensorData_Request__Sequence__destroy(tutorial_interfaces__srv__SensorData_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__srv__SensorData_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__srv__SensorData_Request__Sequence__are_equal(const tutorial_interfaces__srv__SensorData_Request__Sequence * lhs, const tutorial_interfaces__srv__SensorData_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__srv__SensorData_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__srv__SensorData_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__srv__SensorData_Request * data =
      (tutorial_interfaces__srv__SensorData_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__SensorData_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__SensorData_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Request__copy(
...
tutorial_interfaces__srv__SensorData_Response__init(tutorial_interfaces__srv__SensorData_Response * msg)
{
  ...
  if (!std_msgs__msg__Float64MultiArray__init(&msg->data)) {
    tutorial_interfaces__srv__SensorData_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Response * msg = (tutorial_interfaces__srv__SensorData_Response *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__srv__SensorData_Response));
  bool success = tutorial_interfaces__srv__SensorData_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__SensorData_Response__Sequence__init(tutorial_interfaces__srv__SensorData_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Response * data = NULL;

  if (size) {
    data = (tutorial_interfaces__srv__SensorData_Response *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__srv__SensorData_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__srv__SensorData_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tutorial_interfaces__srv__SensorData_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tutorial_interfaces__srv__SensorData_Response__Sequence__fini(tutorial_interfaces__srv__SensorData_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__srv__SensorData_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Response__Sequence * array = (tutorial_interfaces__srv__SensorData_Response__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__srv__SensorData_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__SensorData_Response__Sequence__destroy(tutorial_interfaces__srv__SensorData_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__srv__SensorData_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__srv__SensorData_Response__Sequence__are_equal(const tutorial_interfaces__srv__SensorData_Response__Sequence * lhs, const tutorial_interfaces__srv__SensorData_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__srv__SensorData_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__srv__SensorData_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__srv__SensorData_Response * data =
      (tutorial_interfaces__srv__SensorData_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__SensorData_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__SensorData_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tutorial_interfaces__srv__SensorData_Event__init(tutorial_interfaces__srv__SensorData_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    tutorial_interfaces__srv__SensorData_Event__fini(msg);
    return false;
  }
  // request
  if (!tutorial_interfaces__srv__SensorData_Request__Sequence__init(&msg->request, 0)) {
    tutorial_interfaces__srv__SensorData_Event__fini(msg);
    return false;
  }
  // response
  if (!tutorial_interfaces__srv__SensorData_Response__Sequence__init(&msg->response, 0)) {
    tutorial_interfaces__srv__SensorData_Event__fini(msg);
    return false;
  }
  return true;
...
tutorial_interfaces__srv__SensorData_Event__fini(tutorial_interfaces__srv__SensorData_Event * msg)
{
  ...
  // request
  tutorial_interfaces__srv__SensorData_Request__Sequence__fini(&msg->request);
  // response
  tutorial_interfaces__srv__SensorData_Response__Sequence__fini(&msg->response);
}
...
tutorial_interfaces__srv__SensorData_Event__are_equal(const tutorial_interfaces__srv__SensorData_Event * lhs, const tutorial_interfaces__srv__SensorData_Event * rhs)
{
  ...
  // request
  if (!tutorial_interfaces__srv__SensorData_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!tutorial_interfaces__srv__SensorData_Response__Sequence__are_equal(
  ...
  tutorial_interfaces__srv__SensorData_Event * output)
{
  ...
  // request
  if (!tutorial_interfaces__srv__SensorData_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!tutorial_interfaces__srv__SensorData_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Event * msg = (tutorial_interfaces__srv__SensorData_Event *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces__srv__SensorData_Event));
  bool success = tutorial_interfaces__srv__SensorData_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__SensorData_Event__Sequence__init(tutorial_interfaces__srv__SensorData_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Event * data = NULL;

  if (size) {
    data = (tutorial_interfaces__srv__SensorData_Event *)allocator.zero_allocate(size, sizeof(tutorial_interfaces__srv__SensorData_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces__srv__SensorData_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tutorial_interfaces__srv__SensorData_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tutorial_interfaces__srv__SensorData_Event__Sequence__fini(tutorial_interfaces__srv__SensorData_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces__srv__SensorData_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces__srv__SensorData_Event__Sequence * array = (tutorial_interfaces__srv__SensorData_Event__Sequence *)allocator.allocate(sizeof(tutorial_interfaces__srv__SensorData_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces__srv__SensorData_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tutorial_interfaces__srv__SensorData_Event__Sequence__destroy(tutorial_interfaces__srv__SensorData_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces__srv__SensorData_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces__srv__SensorData_Event__Sequence__are_equal(const tutorial_interfaces__srv__SensorData_Event__Sequence * lhs, const tutorial_interfaces__srv__SensorData_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces__srv__SensorData_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces__srv__SensorData_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces__srv__SensorData_Event * data =
      (tutorial_interfaces__srv__SensorData_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces__srv__SensorData_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces__srv__SensorData_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces__srv__SensorData_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
