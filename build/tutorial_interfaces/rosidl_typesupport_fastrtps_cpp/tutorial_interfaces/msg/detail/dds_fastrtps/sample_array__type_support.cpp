...
#include "tutorial_interfaces/msg/detail/sample_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::SampleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::SampleArray & ros_message)
{
  // Member: data
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::SampleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::SampleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::SampleArray *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_SampleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, SampleArray)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_SampleArray__handle;
}
