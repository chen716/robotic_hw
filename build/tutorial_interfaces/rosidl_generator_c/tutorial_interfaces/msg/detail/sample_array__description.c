  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xfa, 0xb4, 0xad, 0x6e, 0xb1, 0xc0, 0x11, 0x10,
      0x27, 0xf8, 0xb5, 0xc8, 0x5c, 0x89, 0xd7, 0xbc,
      0x9b, 0x5c, 0x4f, 0xd2, 0xea, 0xfd, 0x34, 0x29,
      0x27, 0xf1, 0x87, 0x72, 0xcd, 0xc6, 0x07, 0xf6,
    }};
  return &hash;
}
...
static char tutorial_interfaces__msg__SampleArray__TYPE_NAME[] = "tutorial_interfaces/msg/SampleArray";
...
static char tutorial_interfaces__msg__SampleArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field tutorial_interfaces__msg__SampleArray__FIELDS[] = {
  {
    {tutorial_interfaces__msg__SampleArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription tutorial_interfaces__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {std_msgs__msg__Float64MultiArray__TYPE_NAME, 30, 30},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {tutorial_interfaces__msg__SampleArray__TYPE_NAME, 35, 35},
      {tutorial_interfaces__msg__SampleArray__FIELDS, 1, 1},
    },
    {tutorial_interfaces__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
tutorial_interfaces__msg__SampleArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *tutorial_interfaces__msg__SampleArray__get_individual_type_description_source(NULL),
