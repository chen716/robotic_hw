  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe4, 0xfe, 0x3c, 0x31, 0x1f, 0xb7, 0x27, 0x02,
      0x45, 0x11, 0xd1, 0x57, 0x22, 0x10, 0xdc, 0xaf,
      0x76, 0x2f, 0x2a, 0xce, 0x65, 0xe7, 0xe3, 0xca,
      0x96, 0x86, 0x7c, 0xce, 0xae, 0xc5, 0x7b, 0x6a,
    }};
  return &hash;
}
...
static char sensor_interfaces__msg__SampleArray__TYPE_NAME[] = "sensor_interfaces/msg/SampleArray";
...
static char sensor_interfaces__msg__SampleArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field sensor_interfaces__msg__SampleArray__FIELDS[] = {
  {
    {sensor_interfaces__msg__SampleArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription sensor_interfaces__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {std_msgs__msg__Float64MultiArray__TYPE_NAME, 30, 30},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {sensor_interfaces__msg__SampleArray__TYPE_NAME, 33, 33},
      {sensor_interfaces__msg__SampleArray__FIELDS, 1, 1},
    },
    {sensor_interfaces__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *sensor_interfaces__msg__SampleArray__get_individual_type_description_source(NULL),
