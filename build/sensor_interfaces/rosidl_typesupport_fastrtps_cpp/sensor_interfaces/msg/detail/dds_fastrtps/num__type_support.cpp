...
#include "sensor_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sensor_interfaces::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sensor_interfaces::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &sensor_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_interfaces, msg, Num)() {
  return &sensor_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
