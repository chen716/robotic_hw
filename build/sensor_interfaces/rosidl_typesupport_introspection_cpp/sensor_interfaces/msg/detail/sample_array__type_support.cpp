...
{
  new (message_memory) sensor_interfaces::msg::SampleArray(_init);
}

void SampleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor_interfaces::msg::SampleArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SampleArray_message_member_array[1] = {
  {
    ...
    offsetof(sensor_interfaces::msg::SampleArray, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SampleArray_message_members = {
  ...
  1,  // number of fields
  sizeof(sensor_interfaces::msg::SampleArray),
...
{
  return &::sensor_interfaces::msg::rosidl_typesupport_introspection_cpp::SampleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interfaces, msg, SampleArray)() {
  return &::sensor_interfaces::msg::rosidl_typesupport_introspection_cpp::SampleArray_message_type_support_handle;
}
