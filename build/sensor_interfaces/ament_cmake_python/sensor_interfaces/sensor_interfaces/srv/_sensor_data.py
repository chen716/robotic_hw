...
class SensorData_Event(metaclass=Metaclass_SensorData_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<sensor_interfaces/SensorData_Request, 1>',
        'response': 'sequence<sensor_interfaces/SensorData_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['sensor_interfaces', 'srv'], 'SensorData_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['sensor_interfaces', 'srv'], 'SensorData_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from sensor_interfaces.srv import SensorData_Request
    ...
    def response(self, value):
        if self._check_fields:
            from sensor_interfaces.srv import SensorData_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SensorData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'sensor_interfaces.srv.SensorData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from sensor_interfaces.srv import _sensor_data
...
class SensorData(metaclass=Metaclass_SensorData):
    from sensor_interfaces.srv._sensor_data import SensorData_Request as Request
    from sensor_interfaces.srv._sensor_data import SensorData_Response as Response
    from sensor_interfaces.srv._sensor_data import SensorData_Event as Event
