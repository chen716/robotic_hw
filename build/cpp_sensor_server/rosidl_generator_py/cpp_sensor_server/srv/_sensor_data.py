...
class Metaclass_SensorData_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cpp_sensor_server')
        except ImportError:
            import logging
            import traceback
...
class SensorData_Request(metaclass=Metaclass_SensorData_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.requestsamples = kwargs.get('requestsamples', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.requestsamples != other.requestsamples:
            return False
        return True
    ...
    @builtins.property
    def requestsamples(self):
        """Message field 'requestsamples'."""
        return self._requestsamples

    @requestsamples.setter
    def requestsamples(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'requestsamples' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'requestsamples' field must be an integer in [-2147483648, 2147483647]"
        self._requestsamples = value
...
class SensorData_Event(metaclass=Metaclass_SensorData_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cpp_sensor_server/SensorData_Request, 1>',
        'response': 'sequence<cpp_sensor_server/SensorData_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cpp_sensor_server', 'srv'], 'SensorData_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cpp_sensor_server', 'srv'], 'SensorData_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cpp_sensor_server.srv import SensorData_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from cpp_sensor_server.srv import SensorData_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SensorData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cpp_sensor_server.srv.SensorData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cpp_sensor_server.srv import _sensor_data
...
class SensorData(metaclass=Metaclass_SensorData):
    from cpp_sensor_server.srv._sensor_data import SensorData_Request as Request
    from cpp_sensor_server.srv._sensor_data import SensorData_Response as Response
    from cpp_sensor_server.srv._sensor_data import SensorData_Event as Event
