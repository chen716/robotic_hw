...
class SampleRequest_Event(metaclass=Metaclass_SampleRequest_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cpp_sensor_server/SampleRequest_Request, 1>',
        'response': 'sequence<cpp_sensor_server/SampleRequest_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cpp_sensor_server', 'srv'], 'SampleRequest_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cpp_sensor_server', 'srv'], 'SampleRequest_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cpp_sensor_server.srv import SampleRequest_Request
    ...
    def response(self, value):
        if self._check_fields:
            from cpp_sensor_server.srv import SampleRequest_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SampleRequest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cpp_sensor_server.srv.SampleRequest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cpp_sensor_server.srv import _sample_request
...
class SampleRequest(metaclass=Metaclass_SampleRequest):
    from cpp_sensor_server.srv._sample_request import SampleRequest_Request as Request
    from cpp_sensor_server.srv._sample_request import SampleRequest_Response as Response
    from cpp_sensor_server.srv._sample_request import SampleRequest_Event as Event
