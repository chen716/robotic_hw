  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x6e, 0x22, 0xa1, 0x6d, 0x50, 0xe6, 0x68, 0xee,
      0x93, 0x3c, 0x4f, 0xc0, 0x57, 0x70, 0x38, 0x81,
      0xfe, 0x8d, 0xfd, 0x59, 0xef, 0xc7, 0x21, 0xbb,
      0x84, 0xbe, 0xc7, 0x04, 0x27, 0xf1, 0x02, 0xd1,
    }};
  return &hash;
}
...
static char cpp_sensor_server__msg__SampleArray__TYPE_NAME[] = "cpp_sensor_server/msg/SampleArray";
...
static char cpp_sensor_server__msg__SampleArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field cpp_sensor_server__msg__SampleArray__FIELDS[] = {
  {
    {cpp_sensor_server__msg__SampleArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription cpp_sensor_server__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {std_msgs__msg__Float64MultiArray__TYPE_NAME, 30, 30},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {cpp_sensor_server__msg__SampleArray__TYPE_NAME, 33, 33},
      {cpp_sensor_server__msg__SampleArray__FIELDS, 1, 1},
    },
    {cpp_sensor_server__msg__SampleArray__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *cpp_sensor_server__msg__SampleArray__get_individual_type_description_source(NULL),
