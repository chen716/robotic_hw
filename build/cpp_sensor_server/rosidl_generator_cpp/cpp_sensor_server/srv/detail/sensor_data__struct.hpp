...
struct SensorData_Request_
{
  ...
  using _requestsamples_type =
    int32_t;
  _requestsamples_type requestsamples;

  // setters for named parameter idiom
  Type & set__requestsamples(
    const int32_t & _arg)
  {
    this->requestsamples = _arg;
    return *this;
  }
  ...
  {
    if (this->requestsamples != other.requestsamples) {
      return false;
    }
    return true;
  }
