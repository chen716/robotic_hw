...
class Init_SensorData_Request_requestsamples
{
public:
  Init_SensorData_Request_requestsamples()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::cpp_sensor_server::srv::SensorData_Request requestsamples(::cpp_sensor_server::srv::SensorData_Request::_requestsamples_type arg)
  {
    msg_.requestsamples = std::move(arg);
...
{
  return cpp_sensor_server::srv::builder::Init_SensorData_Request_requestsamples();
}
