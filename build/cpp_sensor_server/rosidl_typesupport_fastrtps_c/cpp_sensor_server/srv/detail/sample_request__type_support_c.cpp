...
#include "cpp_sensor_server/srv/detail/sample_request__rosidl_typesupport_fastrtps_c.h"
...
using _SampleRequest_Request__ros_msg_type = cpp_sensor_server__srv__SampleRequest_Request;
...
size_t get_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
  const void * untyped_ros_message,
...
static uint32_t _SampleRequest_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_sensor_server
size_t max_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_sensor_server__srv__SampleRequest_Request;
    is_plain =
      (
...
static size_t _SampleRequest_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest_Request)() {
...
using _SampleRequest_Response__ros_msg_type = cpp_sensor_server__srv__SampleRequest_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_sensor_server
size_t get_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SampleRequest_Response__ros_msg_type * ros_message = static_cast<const _SampleRequest_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_sensor_server
size_t max_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_sensor_server__srv__SampleRequest_Response;
    is_plain =
      (
...
static size_t _SampleRequest_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest_Response)() {
...
using _SampleRequest_Event__ros_msg_type = cpp_sensor_server__srv__SampleRequest_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      cpp_sensor_server__srv__SampleRequest_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      cpp_sensor_server__srv__SampleRequest_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_sensor_server
size_t get_serialized_size_cpp_sensor_server__srv__SampleRequest_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SampleRequest_Event__ros_msg_type * ros_message = static_cast<const _SampleRequest_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_sensor_server__srv__SampleRequest_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_sensor_server
size_t max_serialized_size_cpp_sensor_server__srv__SampleRequest_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cpp_sensor_server__srv__SampleRequest_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cpp_sensor_server__srv__SampleRequest_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_sensor_server__srv__SampleRequest_Event;
    is_plain =
      (
...
static size_t _SampleRequest_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cpp_sensor_server__srv__SampleRequest_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest_Event)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_sensor_server, srv, SampleRequest)() {
