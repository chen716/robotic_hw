...
#include "cpp_sensor_server/srv/detail/sample_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cpp_sensor_server::srv::SampleRequest_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_sensor_server::srv::SampleRequest_Request & ros_message)
{
  // Member: requestsample
  cdr >> ros_message.requestsample;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_sensor_server::srv::SampleRequest_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_sensor_server::srv::SampleRequest_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_sensor_server::srv::SampleRequest_Request *>(
    untyped_ros_message);
...
{
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_sensor_server, srv, SampleRequest_Request)() {
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_sensor_server
cdr_serialize(
  const cpp_sensor_server::srv::SampleRequest_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_sensor_server::srv::SampleRequest_Response & ros_message)
{
  // Member: data
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_sensor_server::srv::SampleRequest_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_sensor_server::srv::SampleRequest_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_sensor_server::srv::SampleRequest_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_sensor_server, srv, SampleRequest_Response)() {
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Response__handle;
}
...
// functions for cpp_sensor_server::srv::SampleRequest_Request already declared above

// functions for cpp_sensor_server::srv::SampleRequest_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_sensor_server
cdr_serialize(
  const cpp_sensor_server::srv::SampleRequest_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_sensor_server::srv::SampleRequest_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cpp_sensor_server::srv::typesupport_fastrtps_cpp::max_serialized_size_SampleRequest_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cpp_sensor_server::srv::typesupport_fastrtps_cpp::max_serialized_size_SampleRequest_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_sensor_server::srv::SampleRequest_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_sensor_server::srv::SampleRequest_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_sensor_server::srv::SampleRequest_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_sensor_server, srv, SampleRequest_Event)() {
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest_Event__handle;
}
...
static const rosidl_service_type_support_t _SampleRequest__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cpp_sensor_server::srv::SampleRequest_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cpp_sensor_server::srv::SampleRequest_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cpp_sensor_server::srv::SampleRequest_Event>(),
...
{
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_sensor_server, srv, SampleRequest)() {
  return &cpp_sensor_server::srv::typesupport_fastrtps_cpp::_SampleRequest__handle;
}
