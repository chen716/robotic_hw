...
static const _SampleArray_type_support_symbol_names_t _SampleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_sensor_server, msg, SampleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_sensor_server, msg, SampleArray)),
  }
};
...
{
  return &::cpp_sensor_server::msg::rosidl_typesupport_cpp::SampleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp_sensor_server, msg, SampleArray)() {
  return get_message_type_support_handle<cpp_sensor_server::msg::SampleArray>();
}
